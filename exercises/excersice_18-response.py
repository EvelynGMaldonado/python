'''
EXCERCISE #18: LEAST PRIVILEGE PERMISSION LEVELS

    Interview/Test Question might be something like -->

Using the template code provided, fix the code that is vulnerable to least privilege. 
You will need to change the permission level appropriately for each level of users as follows:

a) Admin should have permission to Read, Write, and Execute
b) Users should have permission to Read

You will need to fix the grant permission method.

For example, 
If an Admin input is:
my_dict.txt
Reagan
